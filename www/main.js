...
module.exports = __webpack_require__(/*! /home/marcos/Documentos/personales/marcospp-personal-website/src/main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'message/:id',
        loadChildren: () => Promise.all(/*! import() | view-message-view-message-module */[__webpack_require__.e("common"), __webpack_require__.e("view-message-view-message-module")]).then(__webpack_require__.bind(null, /*! ./view-message/view-message.module */ "eTuU")).then(m => m.ViewMessagePageModule)
    },
    {
        path: '',
        redirectTo: 'home',
